...
var banana ,bananaImage, obstacle, obstacleImage, rocket, rocketImage;
...
function preload(){
  ...
  rocketImage = loadImage("IAMGE!.png")
...
function setup(){
 createCanvas(600,300);
  ...
  monkey = createSprite(230,200,10,10);
  monkey.scale = 0.12;
...
function obstacles(){
  if (frameCount%100 === 0){
    ...
    obstacle.scale = 0.13;
    rocket = createSprite(Math.round(random(-10,-100)),Math.round(random(230,253)),50,50)
    rocket.addAnimation("rocket", rocketImage)
    rocket.scale = 0.13
    rocket.lifetime = 220;
    rocket.velocityX = 4 + score*1.5/100
    obstacle.velocityX = -(4+score*1.5/100);
    obstacle.lifetime = 220;
    obstacleGroup.add(obstacle);
    obstacleGroup.add(rocket)
